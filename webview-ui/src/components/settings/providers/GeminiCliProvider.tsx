...
const SUPPORTED_THINKING_MODELS = ["gemini-2.5-pro", "gemini-3-pro-preview", "gemini-3-flash-preview", "gemini-2.5-flash"]
...
export const GeminiCliProvider = ({ showModelOptions, isPopup, currentMode }: GeminiCliProviderProps) => {
